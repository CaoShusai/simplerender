...
public:
	...
	bool dataExist;
	void prepareData(model& model, PolygonalLight& light);
	void precompute(Shader ShShader, Shader zhToShShader, Shader hermiteShader, PolygonalLight& sceneLight, model& model);
	void precompute(Shader shShader, Shader zhToShShader, Shader hermiteShader,Shader hermiteSecondShader, PolygonalLight& sceneLight, model& model, glm::vec3 cameraPos);
